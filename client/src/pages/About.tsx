...
const About: React.FC = () => {
 ...
 <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/20 to-amber-500/20 blur-3xl rounded-full" />
 <div className="relative bg-neutral-900 border border-neutral-800 p-8 rounded-2xl">
 <h3 className="text-lg font-mono text-yellow-400 mb-4">&gt; System Architecture</h3>

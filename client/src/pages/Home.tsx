...
const Home: React.FC = () => {
 ...
 Detect <span className="bg-gradient-to-r from-yellow-400 to-amber-600 bg-clip-text text-transparent">AI Fakes</span> in Seconds.
 </h1>
 ...
 <Link to="/login" className="px-8 py-4 bg-yellow-600 hover:bg-yellow-500 text-white rounded-full font-semibold text-lg transition-all shadow-lg shadow-yellow-500/25 flex items-center gap-2">
